            ...
            <div class="flex flex-row mb-1 sm:mb-0 justify-between w-full">
                ...
                <div class="text-end">
                    <form class="flex w-full max-w-sm space-x-3">
                        <div class=" relative ">
                            <input type="text" id="search" name="search" class="block w-full appearance-none rounded-lg border border-gray-300 px-4 py-2 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-sky-500" placeholder="Buscar...">
                        </div>
