    ...
    <div class="container mx-auto px-4 sm:px-8 max-w-3xl">
        <div class="py-8">
            <div class="flex flex-row mb-1 sm:mb-0 justify-between w-full">
                ...
                <div class="text-end">
                    <form class="flex w-full max-w-sm space-x-3" method="GET" action="{{ route('applicants.index') }}">
                        <div class="relative">
                                ...
                                <div class="p-4 bg-white border-b border-gray-200">
                                    <div class="flex justify-between">
                                        ...
                                        <div class="mt-4 flex gap-2">
                                            <a href="{{ route('applicants.show', ['id' => $applicant->applicant_id]) }}" class="text-sm bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">Ver Detalle</a>
